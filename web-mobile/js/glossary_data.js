...
export const GLOSSARY = {
  ...
  "kiken": {"id":"kiken","kanji":"棄権","short":"Withdrawal","tooltip":"The competitor withdraws. Two sub-types: Voluntary (FIK Art. 31) — permanent disqualification; Injury (FIK Art. 30) — can be reinstated with doctor and shinpan approval. Opponent wins 2–0."},
  "kiken-voluntary": {"id":"kiken-voluntary","kanji":"棄権","short":"Voluntary withdrawal","tooltip":"FIK Article 31 — the competitor voluntarily withdraws. They forfeit this match (opponent wins 2–0) and are permanently barred from all later matches."},
  "kiken-injury": {"id":"kiken-injury","kanji":"棄権","short":"Injury withdrawal","tooltip":"FIK Article 30 — the competitor withdraws due to injury or illness. They forfeit this match (opponent wins 2–0) but can be reinstated if a doctor and shinpan-in approve."},
