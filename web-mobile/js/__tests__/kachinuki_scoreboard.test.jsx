...
// Walk the vnode tree to find BoutSubRow vnode props (props that have sub +
// numeric index). TeamScoreboard renders them without expanding, so their
// props are accessible at the vnode level.
