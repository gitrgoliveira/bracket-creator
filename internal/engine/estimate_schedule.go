...
//     SOURCE competition's PoolWinners (mirrors buildFinalistResolver/ranking.go).
...
// SOURCE comp.PoolWinners. This mirrors buildFinalistResolver in ranking.go,
...
// mirrors buildFinalistResolver in ranking.go which uses srcComp.PoolWinners.
//
// It reads:
...
func (e *Engine) estimateFinalistCount(srcCompID string) (int, error) {
	...
	// Mirror buildFinalistResolver (ranking.go): use srcComp.PoolWinners,
	// default 2 when ≤0.
