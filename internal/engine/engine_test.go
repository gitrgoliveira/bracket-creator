...
// TestStartCompetition_KnockoutBracketCarriesSideIDsAndPropagates is
...
func TestStartCompetition_KnockoutBracketCarriesSideIDsAndPropagates(t *testing.T) {
	eng, store, _ := setupTestEngine(t)
	compID := "knockout-ids"

	createTestCompetition(t, store, compID, "knockout", 4)
	const (
		idA = "11111111-1111-4111-8111-111111111111"
		idB = "22222222-2222-4222-8222-222222222222"
		idC = "33333333-3333-4333-8333-333333333333"
