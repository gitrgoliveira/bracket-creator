...
describe('shiaijoScoreCell; team and engi numbers are never context-free', () => {
  const orig = {};
  beforeEach(() => {
    orig.iv = window.teamIVScore; orig.ivpw = window.teamIVPWScore; orig.fmt = window.formatIpponsScore; orig.engi = window.engiFlagScore;
  ...
  afterEach(() => {
    window.teamIVScore = orig.iv; window.teamIVPWScore = orig.ivpw; window.formatIpponsScore = orig.fmt; window.engiFlagScore = orig.engi;
  });
