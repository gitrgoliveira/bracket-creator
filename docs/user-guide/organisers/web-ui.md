...
Configure the tournament on the main screen. Choose the format, either Knockout (direct elimination) or Pools + Knockout, then set the number of courts, pool sizes, and other options. Upload your participant CSV directly from the browser.
