...
func (stubCompetitionStore) MatchSidesByID(string, string) (string, string, string, string, bool, error) {
	return "", "", "", "", false, nil
}
...
func (stubScoringEngine) KachinukiEnchoRefusal(string, string, []state.SubMatchResult) error {
	return nil
}
